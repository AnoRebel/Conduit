...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"},{"name":"description","content":"Conduit Server Administration Dashboard"}],"link":[],"style":[],"script":[],"noscript":[],"title":"Conduit Admin"};
